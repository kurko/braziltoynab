...
RSpec.describe BrazilToYnab::PortoSeguro::Xls do
  subject do
    described_class.new(file: 'spec/fixtures/Fatura20220225.xls').get_transactions
  end
  ...
  context "when file has no date" do
    it "raises an error" do
      expect do
        described_class
          .new(file: 'spec/fixtures/Fatura00000000.xls')
          .get_transactions

      end.to raise_error described_class::UndefinedRelativeDate
    end
  end
end
